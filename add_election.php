...
<body>
    <div class="form-container">
        <div class="form-title">Add Election</div>
        ...
        <form method="POST" autocomplete="off">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" required placeholder="Election title">
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" name="description" required placeholder="Election description"></textarea>
            </div>
            <div class="form-group">
